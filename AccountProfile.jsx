...
export default class AccountProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({ 
            url: 'http://advancetaskprofile.azurewebsites.net/profile/profile/getTalentProfile',
            headers: {
    ...
    updateForComponentId(componentId, newValues) {
        console.log("updateand save" + newValues)
        this.updateAndSaveData(newValues)
    }
    saveProfile() {
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'http://advancetaskprofile.azurewebsites.net/profile/profile/updateTalentProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
                                    ...
                                    <div className="ui grid">
                                        ...
                                        >
                                            <SocialMediaLinkedAccount
                                                ...
                                                componentId="SocialMediaLink"
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                        title='Description'
                                        tooltip='Enter a short summary and a description'
                                        >
                                            <Description
                                            saveProfileData={this.updateAndSaveData}
                                            details={details}
                                        ...
                                        >
                                            <PhotoUpload
                                                ...
                                                loadData={this.loadData}
                                                savePhotoUrl='http://advancetaskprofile.azurewebsites.net/profile/profile/updateProfilePhoto'
                                            />
                                        </FormItemWrapper>  
                                    </div>
                                </form>
