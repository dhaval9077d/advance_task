...
namespace Talent.Services.Profile.Domain.Contracts
{
    ...
    {
        bool AddNewLanguage(AddLanguageViewModel language , string id);
        Task<bool> UpdateLanguage(AddLanguageViewModel language);
        Task<bool> RemoveLanguage(AddLanguageViewModel language);
        bool AddNewSkill(AddSkillViewModel skill,string id);
        Task<bool> UpdateSkill(AddSkillViewModel skill, string id);
        Task<bool> RemoveSkill(AddSkillViewModel language);
        bool AddNewExperience(ExperienceViewModel experience, string id);
        Task<bool> UpdateExperience(ExperienceViewModel experience);
        Task<bool> RemoveExperience(ExperienceViewModel experience);
        ...
        //Task<bool> UpdateSocialMediaLinked(TalentProfileViewModel profile, String Id);
